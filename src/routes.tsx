...
export default function Routers() {
    return (
        <Routes>
            ...
            <Route path="/product/brand/" element={<PageList tableBody={LIST_PAGE_BRAND.tableBody} tableHeader={LIST_PAGE_BRAND.tableHeader} title="Brand List" textInput={LIST_PAGE_BRAND.textInput} selectInput={LIST_PAGE_BRAND.selectInput} />} />
